    ...
    return (
        <form>
            ...
            <div className="message">
                <label>Message</label><textarea rows='10' id="message" placeholder="Send me a message and I'll reply you as soon as possible..." required />
                <p className="message_info">Please enter a message</p>
            </div>
