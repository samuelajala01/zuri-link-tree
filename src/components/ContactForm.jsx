    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div className="message">
                <label htmlFor="textarea">Message</label><textarea rows='10' id="message" name="textarea" placeholder="Send me a message and I'll reply you as soon as possible..." value={formValues.textarea} onChange={handleChange} />
